...
namespace Pulumi.AzureStaticWebsite
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AzureStaticWebsite.version.txt");
    ...
    internal sealed class AzureStaticWebsiteResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AzureStaticWebsiteResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
